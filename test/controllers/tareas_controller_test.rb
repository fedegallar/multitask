...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { descripcion: @tarea.descripcion, estado_id: @tarea.estado_id, materium_id: @tarea.materium_id } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { descripcion: @tarea.descripcion, estado_id: @tarea.estado_id, materium_id: @tarea.materium_id } }
